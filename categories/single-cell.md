...
- [[cellxgene]] · [cellxgene](../datasets/cellxgene.md) — CZI aggregator + Census API; standard pretraining substrate for single-cell foundation models.
- [[allen-brain-cell-atlas]] · [allen-brain-cell-atlas](../datasets/allen-brain-cell-atlas.md) — Whole-brain single-cell + MERFISH spatial.
- [[biccn]] · [biccn](../datasets/biccn.md) — *(umbrella)* BRAIN Initiative cell census; trainable output is ABC Atlas.
- [[bican]] · [bican](../datasets/bican.md) — *(umbrella)* BICCN successor; trainable constituents still ramping.
...
- [[rosmap]] · [rosmap](../datasets/rosmap.md) — snRNA-seq subsets including the Mathys et al. AD atlas.
